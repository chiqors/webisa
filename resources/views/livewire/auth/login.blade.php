...
<div class="lg:flex">
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="flex justify-center py-12 bg-indigo-100 lg:bg-white lg:justify-start lg:px-12">
            <div class="flex items-center cursor-pointer">
                ...
                <a href="{{ route('home') }}">
                    <div class="ml-2 text-2xl font-semibold tracking-wide text-indigo-800"> {{ env('APP_NAME') }}</div>
                </a>
            </div>
        </div>
        <div class="px-12 mt-10 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            <h2 class="text-4xl font-semibold text-center text-indigo-900 font-display lg:text-left xl:text-5xl xl:text-bold">Log in</h2>
            <div class="mt-12">
                <form wire:submit.prevent="authenticate">
                    <div>
                        <div class="text-sm font-bold tracking-wide text-gray-700">Username</div>
                        <input wire:model.lazy="username" id="username" name="username" class="w-full py-2 text-lg border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('username') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" type="text" placeholder="Enter your username">
                        @error('username')
