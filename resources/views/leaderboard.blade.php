...
<div class="flex flex-row w-full md:flex-row-reverse md:min-h-screen">
    ...
    <div class="flex flex-row w-full text-gray-700 dark-mode:text-gray-200 dark-mode:bg-gray-800" style="background: url({{ asset('assets/img/map2.jpg') }}); background-repeat: no-repeat; background-position: center; background-size: cover;">
